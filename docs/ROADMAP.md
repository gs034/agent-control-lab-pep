...
Versions below are **lab milestones**, not a vendor SKU. Package `0.3.0` is v0.3 / EOI **M1**. The official allowlist / eval receipt still attests `policy_version: 0.1.0-stub`.
