...
| `pep/approval.py` | Single-use TTL approval store (operator-issued grants bound to tool + canonical args, optionally to a host state digest) |
...
| `docs/ROADMAP.md` | stub → v0.2 → v0.3 / EOI M1 → v0.3.1 approval binding → v0.3.2 late-effect fence → v0.3.3 state digest |
