...
not covered by that approval. Mechanically this is the `approval_ttl`
row with a different story and clock offset; there is no deferred-effect
detector. Threat-model class: deferred tool. This row
